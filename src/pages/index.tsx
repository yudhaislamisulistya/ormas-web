...
function LeafletMap({
  ...
  const buildPopupHtml = (p: {
    ...
    <div style="min-width:240px">
      ...
      ${
        p.alamat
          ? `<div style="margin-top:4px;font-size:12px;opacity:.85">${esc(
              p.alamat
            )}</div>`
          : ""
      }
        ...
        <div className="w-full px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg sm:text-xl font-semibold tracking-tight">
              Si Ormas – Identifikasi Keberadaan Ormas Kab. Mamuju Tengah
            </h1>
          </div>
        </div>
      </header>
            ...
            <div className="space-y-3">
              ...
              {results.map((o) => (
                ...
                <article
                  ...
                  className={`rounded-2xl border p-4 hover:shadow-sm transition cursor-pointer focus:outline-none focus:ring-2 focus:ring-black/20 ${
                    selectedId === o.id
